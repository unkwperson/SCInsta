...
- (NSArray *)specifiers {
    if (!_specifiers) {        
        _specifiers = [NSMutableArray arrayWithArray:@[
            ...
            [self newSwitchCellWithTitle:@"Block Following Button" detailTitle:@"Prevents the following list from opening in your profile" key:@"hide_following_list" defaultValue:false changeAction:nil],
